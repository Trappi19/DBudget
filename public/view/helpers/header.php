...
<body>
	...
	<ul id="side-menu">
		...
		<li><a href="/app/home"><?= t('nav.overview') ?></a></li>
		<li><a href="/app/accounts"><?= t('nav.accounts') ?></a></li>
		<li><a href="/app/budget"><?= t('nav.budget') ?></a></li>
		<li><a href="/app/analytics"><?= t('nav.analytics') ?></a></li>
		<li><a href="/app/operations"><?= t('nav.operations') ?></a></li>
		<li><a href="/app/verification"><?= t('nav.verification') ?></a></li>
		<li><a href="/app/events"><?= t('nav.events') ?></a></li>
