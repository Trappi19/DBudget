...
/**
 * Thin wrapper around PHPMailer, kept with the project's historical Mailer API
 * so existing callers (account verification, contact form) stay unchanged.
 * Sends a multipart text + HTML email over Gmail STARTTLS (port 587).
 */
class Mailer
{
    private string $host;
